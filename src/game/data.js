...
export const FINAL_PATTERN = ["roar", "flurry", "heavy", "guard", "heavy"]; // 深淵の魔王
...
export const PCT_KEYS = ["crit", "critDmg", "lifesteal", "double", "poisonPower", "dmgVsStatus", "afterDefendDmg", "onKillHeal", "onDefendFreezeCh"];
