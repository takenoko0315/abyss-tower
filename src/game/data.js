...
export const STAT_LABELS = { atk: "攻撃", def: "防御", hp: "HP", crit: "クリ率", critDmg: "クリ倍率", lifesteal: "吸血", double: "連撃", thorns: "棘", poisonPower: "毒威力", burnPower: "炎威力", dmgVsStatus: "対状態異常", perHitHeal: "ヒット毎回復", afterDefendDmg: "防御後火力", onKillHeal: "撃破時回復", critVsCC: "対行動不能クリ確定", defendThornsMult: "防御中棘倍加", onDefendFreezeCh: "防御時凍結", onCritCd: "クリ時CD短縮", betterDefend: "防御強化(-80%)", gambleDmg: "気まぐれな打撃", alwaysPoison: "攻撃毎に毒", alwaysBurn: "攻撃毎に炎上", thornsScale: "棘に攻撃力加算", thornsDef: "棘に防御力加算", thornsPoison: "棘が毒を付与", thornsCrit: "棘クリティカル率" };

export const PCT_KEYS = ["crit", "critDmg", "lifesteal", "double", "poisonPower", "burnPower", "dmgVsStatus", "afterDefendDmg", "onKillHeal", "onDefendFreezeCh"];
